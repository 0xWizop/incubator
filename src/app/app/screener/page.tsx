...
function ScreenerContent() {
    ...
    return (
        <div className="h-full overflow-y-auto overscroll-contain">
            <div className="p-0 sm:p-6 pb-20 lg:pb-6">
                {/* Header */}
                ...
                <div className="flex gap-1 sm:gap-2 mb-2 sm:mb-6 overflow-x-auto px-3 sm:px-0 scrollbar-thin relative z-10">
                    ...
                    >
                        ...
                        {watchlists.find(w => w.id === 'favorites')?.tokens.length ? (
                            <span className="px-1.5 py-0.5 bg-[var(--background-tertiary)] border border-[var(--border)] rounded-full text-[10px] font-bold">
                                {watchlists.find(w => w.id === 'favorites')?.tokens.length}
                            </span>
                        ) : null}
                    </button>
